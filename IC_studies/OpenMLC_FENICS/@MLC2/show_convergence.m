     ...
     if length(pop)>=2
         ...
         if strcmp(mlc.parameters.selectionmethod,'tournament')
            ...
            try
                ...
                hold on;
%                 p0=plot3(1:ngen,(1:ngen)*0+J0,(1:ngen)*0+max(max(histo(1:end-1,:)))+1,'--r','linewidth',1.2);                
                p1=plot3([1:ngen;1:ngen;1:ngen;1:ngen]',...
                    [bestJ;medJ;(1:ngen)*0+J0;selJ]',...
                    [bestJ;bestJ;medJ;selJ]'*0+max(max(histo(1:end-1,:)))+1,...
                    'linewidth',2);
                hold off
                ...
                hold on;
                p1=plot3([1:ngen;1:ngen;1:ngen]',...
                    [bestJ;medJ;selJ]',...
                    [bestJ;medJ;selJ]'*0+max(max(histo(1:end-1,:)))+1,...
                    'linewidth',2);
                hold off

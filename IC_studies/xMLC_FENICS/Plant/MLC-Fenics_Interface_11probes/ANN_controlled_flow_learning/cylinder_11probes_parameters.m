function parameters = cylinder_11probes_parameters()
% cylinder_parameters sets the parameters for the cylinder simulation problem.
    ...
    %% Problem parameters
    % Problem
        parameters.Name = 'cylinder_11probes'; % mlc.save_matlab('GenN'); ,mlc.load_matlab('Toy','GenN_moins_un')
        parameters.EvaluationFunction = 'cylinder_11probes'; % external for fortran or experimental
        % Problem variables
    ...
    % Simulation
        ...
        ProblemParameters.eval_steps = 4666;             % number of evaluation steps (first for first evaluation, rest for reevaluations

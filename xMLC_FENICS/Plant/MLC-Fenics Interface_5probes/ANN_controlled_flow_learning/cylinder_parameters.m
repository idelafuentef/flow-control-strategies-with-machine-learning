function parameters = cylinder_parameters()
    ...
    %% Problem parameters
    % Problem
    parameters.Name = 'cylinder'; % mlc.save_matlab('GenN'); ,mlc.load_matlab('Toy','GenN_moins_un')
    parameters.EvaluationFunction = 'cylinder'; % external for fortran or experimental
        % Problem variables
        ...
        % Inputs - Number of sensors and time dependent functions
            % si(t)
            ProblemParameters.NumberSensors = 10;
            ProblemParameters.Sensors = {'a1','a2','a3','a4','a5','a6','a7','a8','a9','a10'}; % name in the problem
          % hi(t)

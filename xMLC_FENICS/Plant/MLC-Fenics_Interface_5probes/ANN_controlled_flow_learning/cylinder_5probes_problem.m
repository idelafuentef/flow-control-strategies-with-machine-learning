...
function J_out=cylinder_5probes_problem(Arrayb,parameters,visu,ind)
...
%     Arrayb=strrep(Arrayb,'a10','Probe_v[4]');
%     Arrayb=strrep(Arrayb,'a9','Probe_v[3]');
%     Arrayb=strrep(Arrayb,'a8','Probe_v[2]');
%     Arrayb=strrep(Arrayb,'a7','Probe_v[1]'); 
%     Arrayb=strrep(Arrayb,'a6','Probe_v[0]');  
%     
%     Arrayb=strrep(Arrayb,'a1','Probe_u[0]');  
%     Arrayb=strrep(Arrayb,'a2','Probe_u[1]');  
%     Arrayb=strrep(Arrayb,'a3','Probe_u[2]');  
%     Arrayb=strrep(Arrayb,'a4','Probe_u[3]');  
%     Arrayb=strrep(Arrayb,'a5','Probe_u[4]');  

function parameters = default_parameters()
    ...
    %% Options and problem
      ...
      % Problem
      parameters.problem = 'toy'; % MOD - /!\ Name of the problem. This name relates to the file "toy_problem.m" in the plant/toy_problem folder.
  ...
  %% gMLC parameters
      parameters.basket_init_size = 100; % MOD
      parameters.basket_size = 10; % MOD
      ...
      % centroid
      parameters.to_build = [];
      parameters.explore_centroid = 0; % should never been used, will be removed
  ...
  %% Problem parameters
    ...
    % inputs are sensors and time dependent functions.
      ...
      % other parameters % MOD - Here put the main parameters of the
      % problem. Put everything that is needed in the *_problem.m file.
      ...
      % actuation limitation -[lower bound,upper bound] % MOD
      act_lim = [-inf,inf];
      ...
      ProblemParameters.PathExt = '../../../Pinball_MLC_OUTPUT/Costs'; % useless if "internal" type of problem
      % Definition

function numerical_DS(gMLC_basket,gMLC_table,gMLC_parameters)
...
%% Ordering
    gMLC_basket.step_ordering(gMLC_parameters);
...
%% Update properties
    gMLC_basket.to_build = vertcat(reflected,expanded,contracted,shrinked);
    gMLC_basket.status.evaluated = 'not evaluated';
    gMLC_basket.status.last_operation = 'numerical DS';
